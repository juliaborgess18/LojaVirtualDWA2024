...
from dtos.nova_categoria_dto import NovaCategoriaDTO
...
# parte do código referente ao CRUD de categorias
...
@router.get("/obter_categoria/{id_categoria:int}")
async def obter_categoria(id_categoria: int):
